...
class HomeworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create homework" do
    assert_difference("Homework.count") do
      post homeworks_url, params: { homework: { category_id: @homework.category_id, due_date: @homework.due_date, title: @homework.title, user_id: @homework.user_id } }
    end
  ...
  test "should update homework" do
    patch homework_url(@homework), params: { homework: { category_id: @homework.category_id, due_date: @homework.due_date, title: @homework.title, user_id: @homework.user_id } }
